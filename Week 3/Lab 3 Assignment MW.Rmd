...
$\color{red}{\text{I'm not sure I understand what's going on on your x-axes here. Your grain sizes should be 1, 2, 5, and 10 here, right? Your answer should thus be the inverse of what you wrote. As grain size increases, variance decreases. This occurs because we are taking the mean of nearby pixels, and the new, larger grained pixels converge on the true mean of all the values, meaning pixels become more and more alike. Also, in order for this to be reproducible, I need you to include a code chunk at the beginning that loads your required packages. +2.5}}$
...
$\color{red}{\text{In what situation might you use the max function to scale up the grain size? +3.5}}$
...
$\color{red}{\text{Nice work on the analysis and figures here, Mars, but you didn't answer the questions. What patterns do you see emerge? +2}}$
...
$\color{red}{\text{Nice. Plus, overall examination of the betas should be suggesting to you that forest cover has a positive effect on skink presence. +3.5}}$
...
$\color{red}{\text{Sure, although you must be careful not to include two variables in the model that are highly correlated with one another, as this can cause variance inflation issues. +2}}$